...
RTMPServer.CommandError = require("./CommandError.js");
 ...
 * @param {Boolean} flag
 */
RTMPServer.enableWarning = function(flag)
{
	//Set flag
	Native.RTMPServerModule.EnableWarning(flag);
};
...
RTMPServer.createClientConnection = function(/** @type {boolean} */ secure)
{
	return new ClientConnection(secure);
}
