...
class IncomingStreamBridge extends Emitter
{
	...
	/**
	 * Set cpu affinity for bridge thread.
	...
	{
		//Set cpu affinity
		return this.bridge.SetAffinity(cpu);
	}

	/**
	 * Set name for bridge thread.
	 *
	...
	setThreadName(name)
	{
		return this.bridge.SetThreadName(name);
	}

	/**
	 * Set thread priority for bridge thread.
	...
	{
		//Set cpu affinity
		return this.bridge.SetPriority(priority);
	}
