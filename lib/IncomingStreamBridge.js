...
class IncomingStreamBridge extends Emitter
{
		...
		/** @type {number} */ maxBufferingTime)
	{
		...
		const cascadedTrack = new Native.MediaFrameListenerBridgeShared(this.bridge.GetTimeService(), 3);
		this.tracks.set("video2",new IncomingStreamTrackBridge("video","video2",SharedPointer(cascadedTrack), this));
