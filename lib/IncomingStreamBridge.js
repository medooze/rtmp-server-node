...
class IncomingStreamBridge extends Emitter
{
	...
	constructor()
	{
		...
		this.tracks.set("audio",new IncomingStreamTrackBrige("audio","audio",this.bridge.GetAudio()));
		this.tracks.set("video",new IncomingStreamTrackBrige("video","video",this.bridge.GetVideo()));
