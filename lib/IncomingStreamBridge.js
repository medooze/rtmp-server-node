...
class IncomingStreamBridge extends Emitter
{
	...
	constructor()
	{
		...
		this.tracks.set("audio",new IncomingStreamTrackBrige("audio","audio",SharedPointer(this.bridge.GetAudio())));
		this.tracks.set("video",new IncomingStreamTrackBrige("video","video",SharedPointer(this.bridge.GetVideo())));
