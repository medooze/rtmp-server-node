...
class IncomingStreamTrackBridge
{
	...
	getStats()
	{
		...
		for (let encoding of this.encodings.values())
		{
			...
			{
				//Update stats
				encoding.bridge.Update();
				//Push new encoding
				this.stats[encoding.id] = {
					waitTime : {
						min		: encoding.bridge.minWaitedTime,
						max		: encoding.bridge.maxWaitedTime,
						avg		: encoding.bridge.avgWaitedTime,
					},
					media	 : {
						numPackets	: encoding.bridge.numPackets,
						numPacketsDelta	: encoding.bridge.numPacketsDelta,
						numFrames	: encoding.bridge.numFrames,
						numFramesDelta	: encoding.bridge.numFramesDelta,
						totalBytes	: encoding.bridge.totalBytes,
						bitrate		: encoding.bridge.bitrate,
						layers		: []
					},
					rtx	 : {},
				};
	...
	*/
	...
	getSSRCs()
	{
		...
		for (let encoding of this.encodings.values())
			//Push new encoding
			ssrcs[encoding.id] = {
				media : encoding.bridge.media,
				rtx   : encoding.bridge.rtx,
			};
