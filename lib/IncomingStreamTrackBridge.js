...
class IncomingStreamTrackBridge extends Emitter
{
	...
	addEncoding(id , /** @type SharedPointer.Proxy<Native.MediaFrameListenerBridgeShared>} */ bridge)
	{
		//Create encoding
		const encoding = {
			id		: id,
		...
		//TODO: Should we replace the packetizer with a SimulcastFrameListener here?
		//In theory, enhanced rtmp implementations do not remove the base layer, but who knows.. 
		//Emit pending encoding event
